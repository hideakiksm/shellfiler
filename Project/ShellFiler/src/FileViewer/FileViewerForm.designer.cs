namespace ShellFiler.FileViewer {
    partial class FileViewerForm {
        ...
        private void InitializeComponent() {
            this.menuStrip = new FileViewerMenuStrip();
            this.toolStrip = new FileViewerToolbarStrip();
            this.statusStrip = new FileViewerStatusBar();
            ...
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FileViewerForm_FormClosing);
            this.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(FileViewerForm_PreviewKeyDown);
            this.KeyUp += new System.Windows.Forms.KeyEventHandler(FileViewerForm_KeyUp);
        ...
        private FileViewerMenuStrip menuStrip;
        private FileViewerToolbarStrip toolStrip;
        private ShellFiler.UI.ControlBar.FunctionBar functionBar;
        private FileViewerStatusBar statusStrip;
