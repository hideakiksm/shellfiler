...
namespace ShellFiler.GraphicsViewer.Filter {
    ...
    class ComponentSharp : IFilterComponent {
        ...
        private void SetPixel(int pos1, int pos2, int pos3, int x) {
            ...
            m_destImage[pos2 + x * 3    ] = (byte)(Math.Min(255f, Math.Max(0f, (-srcB21 - srcB12 - srcB32 - srcB23 + srcB22 * 4) * m_filterLevel + srcB22)));
            m_destImage[pos2 + x * 3 + 1] = (byte)(Math.Min(255f, Math.Max(0f, (-srcG21 - srcG12 - srcG32 - srcG23 + srcG22 * 4) * m_filterLevel + srcG22)));
            m_destImage[pos2 + x * 3 + 2] = (byte)(Math.Min(255f, Math.Max(0f, (-srcR21 - srcR12 - srcR32 - srcR23 + srcR22 * 4) * m_filterLevel + srcR22)));
        }
