...
namespace ShellFiler.Terminal.TerminalSession.CommandEmulator {
    ...
    //=========================================================================================
    // クラス：コンソールを初期化するためのエミュレータエンジン
    //=========================================================================================
    public class ShellEngineInitializeConsole : IShellEmulatorEngine {
        // 所有オブジェクト
        ...
        // 戻り値：なし
        //=========================================================================================
        public ShellEngineInitializeConsole(ShellCommandEmulator parent, SSHConnection connection) {
        ...
        public string GetRequest() {
            ...
            string strCommand = dictionary.GetCommandChangePrompt(m_shellCommandEmulator.PromptStringSend);
            return strCommand;
        }
