...
namespace ShellFiler.MonitoringViewer.NetStatInetMonitor {
    ...
    //=========================================================================================
    public class NetStatInetMonitoringViewer : IMonitoringViewer {
        ...
        // 戻り値：なし
        //=========================================================================================
        public NetStatInetMonitoringViewer(LinuxSpaceSeparateValueStore dataStore, CommandRetryInfo retryInfo) {
        ...
        public void OnParseCompleted(byte[] data, Encoding encoding, string errorInfo) {
            ...
            if (data != null) {
                NetStatInetResultPraser parser = new NetStatInetResultPraser(encoding);
        ...
        public MonitoringViewerMode Mode {
            get {
                return MonitoringViewerMode.NetStatInet;
            }
        }
        ...
        public string Title {
            get {
                return Resources.MonitorView_TitleNetStatInet;
            }
        }
