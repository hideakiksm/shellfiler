...
namespace ShellFiler.UI.Log {
    ...
    // クラス：ログビューでの選択範囲
    //=========================================================================================
    public class LogViewSelectionRange {
        // 選択開始行のログ行ID（選択していないとき-1） ※必ずm_selectStartがm_selectEndより左上にある
        private long m_startLine = -1;
        ...
        // 選択ではじめにクリックした位置の行のログ行ID
        private long m_firstClickLine = -1;
        
        // 選択ではじめにクリックした位置の桁
        private int m_firstClickColumn = -1;

        // 直前の選択位置の行のログ行ID
        private long m_prevLine = -1;
        ...
        //=========================================================================================
        // プロパティ：選択ではじめにクリックした位置の行のログ行ID（選択していないとき-1）
        //=========================================================================================
        public long FirstClickLine {
            get {
