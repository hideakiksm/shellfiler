...
namespace ShellFiler.Command.FileViewer.Edit {
    ...
    //=========================================================================================
    // クラス：コマンドを実行する
    // 選択範囲を左側の比較対象として登録し、左右がそろった場合は差分表示ツールで比較します。
    //   書式 　 V_SelectionCompareLeft()
    //   引数  　なし
    //   戻り値　なし
    //   対応Ver 1.0.0
    //=========================================================================================
    class V_SelectionCompareLeftCommand : FileViewerActionCommand {
        ...
        // 戻り値：なし
        //=========================================================================================
        public V_SelectionCompareLeftCommand() {
        }
        ...
        public override object Execute() {
            ...
            buffer.LeftString = text;
            buffer.LeftStartLineNum = textModeViewer.SelectionRange.StartLine;
            if (buffer.RightString == null) {
                InfoBox.Information(this.TextFileViewer.FileViewerForm, Resources.Msg_ViewerSelectionCompareTextLeft);
                return null;
            }
        ...
        public override UIResource UIResource {
            get {
                return UIResource.V_SelectionCompareLeftCommand;
            }
        }
    }
}