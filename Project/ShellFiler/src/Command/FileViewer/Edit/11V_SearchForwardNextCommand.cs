...
namespace ShellFiler.Command.FileViewer.Edit {
    ...
    //=========================================================================================
    // クラス：コマンドを実行する
    // 前回の検索条件を使って、前方方向に検索します。
    //   書式 　 V_SearchForwardNext()
    //   引数  　なし
    //   戻り値　検索を開始したときtrue
    //   対応Ver 0.0.1
    //=========================================================================================
    class V_SearchForwardNextCommand : FileViewerActionCommand {
        ...
        // 戻り値：なし
        //=========================================================================================
        public V_SearchForwardNextCommand() {
        }
        ...
        public override UIResource UIResource {
            get {
                return UIResource.V_SearchForwardNextCommand;
            }
        }
    }
}
