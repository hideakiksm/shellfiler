...
namespace ShellFiler.Command.GraphicsViewer.Filter {
    ...
    //   対応Ver 0.0.1
    //=========================================================================================
    class G_FilterSepiaCommand : GraphicsViewerActionCommand {
        ...
        public override object Execute() {
            ...
            G_FilterBlurCommand.ModifyFilterParam(GraphicsViewerPanel, typeof(ComponentSepia), deltaList);
            return null;
        }
        ...
        public override UIResource UIResource {
            get {
                return UIResource.G_FilterSepiaCommand;
            }
        }
    }
}
