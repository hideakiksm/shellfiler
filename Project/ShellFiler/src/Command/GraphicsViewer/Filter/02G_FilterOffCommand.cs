...
namespace ShellFiler.Command.GraphicsViewer.Filter {
    ...
    //   対応Ver 0.0.1
    //=========================================================================================
    class G_FilterOnOffCommand : GraphicsViewerActionCommand {
        ...
        public override object Execute() {
            ...
            setting.UseFilter = !setting.UseFilter;
        ...
        public override UIResource UIResource {
            get {
                return UIResource.G_FilterOnOffCommand;
            }
        }
    }
}
