...
namespace ShellFiler.Command.GraphicsViewer.Filter {
    ...
    //=========================================================================================
    // クラス：コマンドを実行する
    // カラーレリーフフィルターをレベル{0}で適用します。
    //   書式 　 G_FilterRelief(int level)
    ...
    //   対応Ver 0.0.1
    //=========================================================================================
    class G_FilterReliefCommand : GraphicsViewerActionCommand {
        // 適用レベルの差分
        ...
        public override object Execute() {
            ...
            G_FilterBlurCommand.ModifyFilterParam(GraphicsViewerPanel, typeof(ComponentRelief), deltaList);
            return null;
        }
        ...
        public override UIResource UIResource {
            get {
                return UIResource.G_FilterReliefCommand;
            }
        }
    }
}
