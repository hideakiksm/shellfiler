...
namespace ShellFiler.Command.GraphicsViewer.View {
    ...
    //=========================================================================================
    // クラス：コマンドを実行する
    // 拡大率を最大の{0}/1000だけ増加するようにズームインします。
    //   書式 　 G_ZoomInEx(int zoom)
    //   引数  　zoom:ズームする割合
    // 　　　　　zoom-default:100
    // 　　　　　zoom-range:1,1000
    //   戻り値　なし
    //   対応Ver 0.0.1
    //=========================================================================================
    class G_ZoomInExCommand : GraphicsViewerActionCommand {
        // ズームする割合
        private int m_zoom;
        ...
        public override UIResource UIResource {
            get {
                return UIResource.G_ZoomInExCommand;
            }
        }
    }
}
