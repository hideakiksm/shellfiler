...
namespace ShellFiler.Command.GraphicsViewer.View {
    ...
    //=========================================================================================
    // クラス：コマンドを実行する
    // 画面を上に{0}ピクセルだけスクロールします。
    //   書式 　 G_ScrollUp(int pixel)
    ...
    //   対応Ver 0.0.1
    //=========================================================================================
    class G_ScrollUpCommand : GraphicsViewerActionCommand {
        // スクロールするピクセル数
        private int m_pixel;
        ...
        public override UIResource UIResource {
            get {
                return UIResource.G_ScrollUpCommand;
            }
        }
    }
}
