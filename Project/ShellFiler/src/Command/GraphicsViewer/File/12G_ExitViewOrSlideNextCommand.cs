...
namespace ShellFiler.Command.GraphicsViewer.File {
    ...
    //=========================================================================================
    // クラス：コマンドを実行する
    // グラフィックビューアを終了します。スライドショーの場合は次へ進めます。
    //   書式 　 G_ExitViewOrNextSlide()
    //   引数  　なし
    //   戻り値　なし
    //   対応Ver 0.0.1
    //=========================================================================================
    class G_ExitViewOrNextSlideCommand : GraphicsViewerActionCommand {
        ...
        // 戻り値：なし
        //=========================================================================================
        public G_ExitViewOrNextSlideCommand() {
        }
        ...
        public override object Execute() {
            if (GraphicsViewerPanel.GraphicsViewerForm.SlideShowMode) {
                G_SlideShowNextCommand.ExecutePrevNext(GraphicsViewerPanel, true, true);
            } else {
        ...
        public override UIResource UIResource {
            get {
                return UIResource.G_ExitViewOrNextSlideCommand;
            }
        }
    }
}
