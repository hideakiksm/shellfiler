...
namespace ShellFiler.Command.Terminal.View {
    ...
    //=========================================================================================
    // クラス：コマンドを実行する
    // 入力ビューを上に{0}ページ分だけスクロールします。
    //   書式 　 T_ScrollRollUpCurrent()
    //   引数  　なし
    //   戻り値　なし
    //   対応Ver 2.0.0
    //=========================================================================================
    class T_ScrollRollUpCurrentCommand : TerminalActionCommand {
        ...
        // 戻り値：なし
        //=========================================================================================
        public T_ScrollRollUpCurrentCommand() {
        }
        ...
        public override UIResource UIResource {
            get {
                return UIResource.T_ScrollRollUpCurrentCommand;
            }
        }
    }
}
