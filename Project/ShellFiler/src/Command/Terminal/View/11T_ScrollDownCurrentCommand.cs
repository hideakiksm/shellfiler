...
namespace ShellFiler.Command.Terminal.View {
    ...
    //   書式 　 T_ScrollDownCurrent(int line)
    //   引数  　line:スクロールする行数
    // 　　　　　line-default:1
    // 　　　　　line-range:1,999999
    //   戻り値　なし
    //   対応Ver 2.0.0
    //=========================================================================================
    class T_ScrollDownCurrentCommand : TerminalActionCommand {
        // スクロールする行数
        private int m_line;
        ...
        // 戻り値：なし
        //=========================================================================================
        public T_ScrollDownCurrentCommand() {
        }
        ...
        public override UIResource UIResource {
            get {
                return UIResource.T_ScrollDownCurrentCommand;
            }
        }
    }
}
