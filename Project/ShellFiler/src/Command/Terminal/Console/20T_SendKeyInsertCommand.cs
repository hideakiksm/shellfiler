...
namespace ShellFiler.Command.Terminal.Console {
    ...
    //   対応Ver 2.0.0
    //=========================================================================================
    class T_SendKeyInsertCommand : TerminalActionCommand {
        ...
        public override object Execute() {
            string command = ConsoleScreen.CH_ESC + "[2~";
        ...
        public override UIResource UIResource {
            get {
                return UIResource.T_SendKeyInsertCommand;
            }
        }
    }
}
