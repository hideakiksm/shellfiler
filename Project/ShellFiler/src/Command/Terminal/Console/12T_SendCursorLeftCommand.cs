...
namespace ShellFiler.Command.Terminal.Console {
    ...
    //   対応Ver 2.0.0
    //=========================================================================================
    class T_SendCursorLeftCommand : TerminalActionCommand {
        ...
        // 戻り値：なし
        //=========================================================================================
        public T_SendCursorLeftCommand() {
        }
        ...
        public override object Execute() {
            ...
            if (TerminalPanel.ConsoleScreen.TerminalMode == TerminalModeType.Normal) {
                command = ConsoleScreen.CH_ESC + "[D";
            } else {
                command = ConsoleScreen.CH_ESC + "OD";
            }
        ...
        public override UIResource UIResource {
            get {
                return UIResource.T_SendCursorLeftCommand;
            }
        }
    }
}
