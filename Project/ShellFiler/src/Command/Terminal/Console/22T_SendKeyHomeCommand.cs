...
namespace ShellFiler.Command.Terminal.Console {
    ...
    //   対応Ver 2.0.0
    //=========================================================================================
    class T_SendKeyHomeCommand : TerminalActionCommand {
        ...
        public override object Execute() {
            string command = ConsoleScreen.CH_ESC + "[7~";
        ...
        public override UIResource UIResource {
            get {
                return UIResource.T_SendKeyHomeCommand;
            }
        }
    }
}
