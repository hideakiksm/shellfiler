...
namespace ShellFiler.Command.FileList.ChangeDir {
    ...
    //   対応Ver 0.0.1
    //=========================================================================================
    class PathHistoryPrevCommand : FileListActionCommand {
        ...
        public override object Execute() {
            ...
            return ChdirCommand.ChangeDirectory(FileListViewTarget, new ChangeDirectoryParam.PathHistoryPrev(item));
        }
        ...
        public override UIResource UIResource {
            get {
                return UIResource.PathHistoryPrevCommand;
            }
        }
    }
}
