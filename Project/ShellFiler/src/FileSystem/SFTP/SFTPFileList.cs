...
namespace ShellFiler.FileSystem.SFTP {
    ...
    // クラス：ファイル一覧の情報
    //=========================================================================================
    public class SFTPFileList : IFileList {
        // ファイルシステム
        private SFTPFileSystem m_fileSystem;
        ...
        private SFTPFileListContext m_fileListContext;
        ...
        // 戻り値：なし
        //=========================================================================================
        public SFTPFileList(IFileSystem fileSystem, string directory, bool isLeftWindow) {
            // ディレクトリを変更
            m_fileSystem = (SFTPFileSystem)fileSystem;
        ...
        public IFileListContext FileListContext {
            ...
            set {
                m_fileListContext = (SFTPFileListContext)value;
            }
        }
    }
}
