...
namespace ShellFiler.FileSystem.SFTP {
    ...
    public class SFTPFileSystem : IFileSystem {
        ...
        // 戻り値：なし
        //=========================================================================================
        public SFTPFileSystem(SSHConnectionManager manager) {
        ...
        //=========================================================================================
        public void GetUIFileList(FileOperationRequestContext context, SFTPFileList fileList, string directory, bool isLeftWindow, ChangeDirectoryParam chdirMode) {
            SFTPGetUIFileListArg arg = new SFTPGetUIFileListArg(context, fileList, directory, chdirMode);
        ...
        public IFileList CreateFileListFromExisting(string directory, bool isLeftWindow, IFileListContext fileListCtx) {
            SFTPFileList fileList = new SFTPFileList(this, directory, isLeftWindow);
            return fileList;
        }
        ...
        public FileOperationStatus GetFileList(FileOperationRequestContext context, string directory, out List<IFile> fileList) {
            ...
            try {
                SFTPGetFileListProcedure procedure = new SFTPGetFileListProcedure(connection, context);
        ...
        public FileOperationStatus TransferDownload(FileOperationRequestContext context, string srcLogicalPath, string destLogicalPath, string destPhysicalPath, IFile srcFileInfo, FileProgressEventHandler progress) {
            ...
            try {
                SFTPDownloadFileProcedure procedure = new SFTPDownloadFileProcedure(connection, context);
                status = procedure.Execute(context, srcLogicalPath, destPhysicalPath, progress);
            } finally {
                connection.CompleteRequest();
            }
            return status;
        ...
        public FileOperationStatus TransferUpload(FileOperationRequestContext context, string srcLogicalPath, string destLogicalPath, string srcPhysicalPath, FileProgressEventHandler progress) {
            ...
            try {
                SFTPTransferUploadProcedure procedure = new SFTPTransferUploadProcedure(connection, context);
        ...
        public FileOperationStatus GetFileInfo(FileOperationRequestContext context, string filePath, bool isTarget, out IFile fileInfo) {
            ...
            try {
                SFTPGetFileInfoProcedure procedure = new SFTPGetFileInfoProcedure(connection, context);
                status = procedure.Execute(filePath, out fileInfo);
            } finally {
                connection.CompleteRequest();
            }
            return status;
        ...
        public FileOperationStatus SetFileInfo(FileOperationRequestContext context, IFile srcFileInfo, string destFilePath, bool baseAttr, bool allAttr) {
            ...
            try {
                SFTPFile sshFile = (SFTPFile)srcFileInfo;
                SFTPSetFileInfoProcedure procedure = new SFTPSetFileInfoProcedure(connection, context);
        ...
        public FileOperationStatus CreateDirectory(FileOperationRequestContext context, string basePath, string newName, bool isTarget) {
            ...
            try {
                SFPCreateDirectoryProcedure procedure = new SFPCreateDirectoryProcedure(connection, context);
                status = procedure.Execute(basePath, newName);
            } finally {
                connection.CompleteRequest();
            }
            return status;
        ...
        public FileOperationStatus RemoteCopyDirectoryDirect(FileOperationRequestContext context, string srcFilePath, string destFilePath, bool attrCopy, FileProgressEventHandler progress) {
            ...
            if (sameSession) {
                ...
                // コピー/移動を実行する
                try {
                    SFTPRemoteFileTransferProcedure procedure = new SFTPRemoteFileTransferProcedure(connection, context);
        ...
        public FileOperationStatus CreateShortcut(FileOperationRequestContext cache, string srcFilePath, string destFilePath, bool overwrite, ShortcutType type) {
            SSHConnection connection;
            FileOperationStatus status = m_connectionManager.GetSSHConnection(cache, destFilePath, out connection);
            if (status != FileOperationStatus.Success) {
                return status;
            }
            try {
                CreateShortcutProcedure procedure = new CreateShortcutProcedure(connection, cache);
                status = procedure.Execute(srcFilePath, destFilePath, overwrite, type);
            } finally {
                connection.CompleteRequest();
            }
            return status;
        ...
        public FileOperationStatus CombineFile(FileOperationRequestContext context, List<string> srcFilePath, string destFilePath, ITaskLogger taskLogger) {
            ...
            // 属性コピー時、srcFileInfoAttrは無視
            try {
                SFTPCombineFileProcedure procedure = new SFTPCombineFileProcedure(connection, context);
        ...
        public FileOperationStatus SplitFile(FileOperationRequestContext context, string srcFilePath, string destFolderPath, RenameNumberingInfo numberingInfo, SplitFileInfo splitInfo, ITaskLogger taskLogger) {
            ...
            // 属性コピー時、srcFileInfoAttrは無視
            try {
                SFTPSplitFileProcedure procedure = new SFTPSplitFileProcedure(connection, context);
                status = procedure.Execute(context, srcFilePath, destFolderPath, numberingInfo, splitInfo, taskLogger);
            } finally {
                connection.CompleteRequest();
            }
            return status;
        ...
        public FileOperationStatus DeleteFileFolder(FileOperationRequestContext context, string filePath, bool isTarget, DeleteFileFolderFlag flag) {
            ...
            try {
                SFTPDeleteProcedure procedure = new SFTPDeleteProcedure(connection, context);
        ...
        public FileOperationStatus Rename(FileOperationRequestContext cache, string path, RenameFileInfo orgInfo, RenameFileInfo newInfo) {
            ...
            try {
                SFTPRenameProcedure procedure = new SFTPRenameProcedure(connection, cache);
        ...
        public FileOperationStatus ModifyFileInfo(FileOperationRequestContext cache, string path, RenameSelectedFileInfo renameInfo, ModifyFileInfoContext modifyCtx) {
            ...
            try {
                SFTPModifyFileInfoProcedure procedure = new SFTPModifyFileInfoProcedure(connection, cache);
        ...
        public FileOperationStatus RetrieveImage(FileOperationRequestContext cache, string filePath, long maxSize, out BufferedImage image) {
            ...
            try {
                RetrieveImageProcedure procedure = new RetrieveImageProcedure(connection, cache);
        ...
        public FileOperationStatus RetrieveFileChunk(FileOperationRequestContext cache, AccessibleFile file) {
            ...
            try {
                SFTPRetrieveFileChunkProcedure procedure = new SFTPRetrieveFileChunkProcedure(connection, cache);
        ...
        public FileOperationStatus RemoteExecute(FileOperationRequestContext context, string dirName, string command, List<OSSpecLineExpect> errorExpect, bool relayOutLog, bool relayErrLog, IRetrieveFileDataTarget dataTarget) {
            ...
            try {
                SFTPShellExecuteProcedure procedure = new SFTPShellExecuteProcedure(connection, context);
                status = procedure.Execute(dirName, command, relayErrLog, dataTarget);
            } finally {
                connection.CompleteRequest();
            }
            return status;
        ...
        public FileOperationStatus RetrieveFolderSize(FileOperationRequestContext context, string directory, RetrieveFolderSizeCondition condition, RetrieveFolderSizeResult result, FileProgressEventHandler progress) {
            ...
            try {
                SFTPRetrieveFolderSizeProcedure procedure = new SFTPRetrieveFolderSizeProcedure(connection, context, condition, result);
        ...
        public bool IsAbsolutePath(string directory, IFileListContext fileListCtx) {
            ...
            if (virtualInfo == null) {
                return SSHUtils.IsAbsolutePath(SSHProtocolType.SFTP, directory);
            } else {
