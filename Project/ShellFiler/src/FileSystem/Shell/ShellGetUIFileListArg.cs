...
namespace ShellFiler.FileSystem.Shell {
    ...
    //=========================================================================================
    public class ShellGetUIFileListArg : AbstractProcedureArg {
        ...
        // 戻り値：なし
        //=========================================================================================
        public ShellGetUIFileListArg(FileOperationRequestContext context, IFileList fileList, string directory, ChangeDirectoryParam chdirMode) : base(context) {
            m_fileList = fileList;
